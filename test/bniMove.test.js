import { BNIClient, BNIMove } from '../src/index.js';
...
describe('bniMove.js', () => {
  describe('prescreening.js', () => {
    it('should return statusCode 0', async () => {
      return prescreening().then((res) => strictEqual(res.statusCode, 0));
    });
  });
  describe('saveImage.js', () => {
    it('should return statusCode 0', async () => {
      return saveImage().then((res) => strictEqual(res.statusCode, 0));
    });
  });
});
